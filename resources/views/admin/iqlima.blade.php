                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                ...
                                <div class="button-wrapper">
                                    <h1 class="text-muted">Iqlima Fasha Rizqia</h1>
                        ...
                        <div class="card-body">
                            <form id="formAccountSettings" method="POST" onsubmit="return false">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="firstName" name="firstName" value="Iqlima" />
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="lastName" class="form-label">Last Name</label>
                                    <input class="form-control" type="text" name="lastName" id="lastName" value="Rizqia" />
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="email" class="form-label">E-mail</label>
                                    <input class="form-control" type="text" id="email" name="email" value="iqli22006si@student.nurulfikri.ac.id" />
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" id="phoneNumber" name="phoneNumber" class="form-control" value="853 6127 8903"/>
                                    </div>
                                </div>
                                <div class="mb-3 col-md-6">
                        ...
                        <div class="d-flex mb-3">
                                ...
                                <div class="flex-grow-1 row">
                                    <div class="col-8 col-sm-7 mb-sm-0 mb-2">
                                        ...
                                        <small class="text-muted">Not Connected</small>                                    </div>
                                    <div class="col-4 col-sm-5 text-end">
                                        <button type="button" class="btn btn-icon btn-outline-secondary" disabled>
                                        <i class="bx bx-link-alt"></i>
                                        </button>
                        ...
                        <div class="d-flex mb-3">
                                ...
                                <div class="flex-grow-1 row">
                                    <div class="col-8 col-sm-7 mb-sm-0 mb-2">
                                        ...
                                        <a href="https://www.instagram.com/iqlimafsha/" target="_blank">@iqlimafsha</a>
                                    </div>
                                    <div class="col-4 col-sm-5 text-end">
                                        <a href="https://www.instagram.com/iqlimafsha/">
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="flex-grow-1 row">
                                <div class="col-8 col-sm-7 mb-sm-0 mb-2">
                                    ...
                                    <a href="https://github.com/iqlimafasha" target="_blank">@iqlimafasha</a>
                                </div>
                                <div class="col-4 col-sm-5 text-end">
                                    <a href="https://github.com/iqlimafasha">
                                    <button type="button" class="btn btn-icon btn-outline-info">
                                    <i class="bx bx-link-alt"></i>
                                    </button></a>
                                </div>
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="flex-grow-1 row">
                                <div class="col-8 col-sm-7 mb-sm-0 mb-2">
                                    ...
                                    <a href="https://www.google.com/" target="_blank">iqli22006si@student.nurulfikri.ac.id</a>
                                </div>
                                <div class="col-4 col-sm-5 text-end">
